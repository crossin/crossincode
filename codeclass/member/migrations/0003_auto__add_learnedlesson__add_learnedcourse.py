...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'member_learnedlesson', (
            ...
            ('time_learned', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'member', ['LearnedLesson'])

        # Adding model 'LearnedCourse'
        db.create_table(u'member_learnedcourse', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['member.Student'])),
            ...
            ('time_learned', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'member', ['LearnedCourse'])


    def backwards(self, orm):
        # Deleting model 'LearnedLesson'
        db.delete_table(u'member_learnedlesson')

        # Deleting model 'LearnedCourse'
        db.delete_table(u'member_learnedcourse')
    ...
    models = {
        ...
        u'member.learnedcourse': {
            'Meta': {'object_name': 'LearnedCourse'},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['school.Course']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'progress': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['member.Student']"}),
            'time_learned': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'member.learnedlesson': {
            'Meta': {'object_name': 'LearnedLesson'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lesson': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['school.Lesson']"}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['member.Student']"}),
            'time_learned': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        u'member.student': {
