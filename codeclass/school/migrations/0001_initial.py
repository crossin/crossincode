...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'school_language', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'school', ['Language'])
        ...
        db.create_table(u'school_course', (
            ...
            ('language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['school.Language'])),
        ))
        ...
        db.create_table(u'school_lesson', (
            ...
            ('quiz', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['oj.Quiz'], unique=True, null=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'school_language')
